...
layer = {
    ...
    "linearattn":"src.models.sequence.norm_linear_attention.NormLinearAttention",
    "localattn":"src.models.sequence.norm_local_attention.NormLocalAttention",
    "ls_attn":"src.models.sequence.ls_attention.LSAttentionNonCausal",
