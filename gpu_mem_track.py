...
class MemTracker(object):
    ...
    """
    def __init__(self, frame, arch, seq_len, detail=True, path='/mnt/DATA/hxd/lra/debug/', verbose=False, device=0):
        self.frame = frame
        self.print_detail = detail
        self.last_tensor_sizes = set()
        self.gpu_profile_fn = path + f'{arch}-{seq_len}-gpu_mem_track.txt'
