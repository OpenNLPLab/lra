...
# Scheduler
parser.add_argument(
    "--patience", default=10, type=float, help="Patience for learning rate scheduler"
)
# Dataset
parser.add_argument(
    "--dataset",
...
def setup_optimizer(model, lr, weight_decay, patience):
    ...
    hps = [dict(s) for s in set(frozenset(hp.items()) for hp in hps)]  # Unique dicts
    for hp in hps:
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
        optimizer, patience=patience, factor=0.2
    )
